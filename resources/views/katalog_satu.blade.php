...
<body>
    ...
    <section class="pt-36 pb-24">
        <div class="container">
            <div class="text-center">
                <h2 class="md:text-5xl/tight text-3xl font-semibold mb-6">{{ $katalog->judul }}</h2>
            </div>
            <!-- meta start -->
            <div class="grid md:grid-cols-3 grid-cols-3 gap-6 items-center border-y py-8 mt-14">
                <div class="text-center">
                    <span>Author</span>
                    <h4>{{ $katalog->author }}</h4>
                </div>

                <div class="text-center">
                    <span>Category</span>
                    <h4>{{ $katalog->kategori }}</h4>
                </div>
    ...
    <section class="pb-20">
        <div class="container">
            ...
            <!-- description start -->
            <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mt-16">
                <div>
                    <div>
                        <img src="{{ url('storage/' . $katalog->foto) }}" class="rounded-md">
                    </div>
                </div>

                <div>
                    <h3 class="text-2xl">Deskripsi</h3>
                    <p class="mt-5">{{ $katalog->deskripsi }}</p>
                </div>
            </div>
            <!-- description end -->
            ...
            <div class="mt-16">
                <div>
                    <h3 class="text-2xl">What We Did?</h3>
                    <p class="text-slate-800 mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit officia neque beatae at
                ...
                <div class="grid md:grid-cols-3 grid-cols-1 gap-6 my-12">
                    <div class="flex items-center gap-5">
                        <div class="w-12 h-12 bg-primary/10 flex items-center justify-center rounded-md">
                        ...
                        <div>
                            <h5 class="text-base">UI/UX Design</h5>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <h5 class="text-base">Brand Identity</h5>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            <h5 class="text-base">Web Devblopment</h5>
                        </div>
                    </div>
                </div>

                <p class="text-slate-800"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit officia neque beatae at
                    inventore excepturi numquam sint commodi alias, quam consequuntur corporis ex, distinctio
                    eaque sapiente pariatur iure ad necessitatibus in quod obcaecati natus consequatur. Sed dicta
                    maiores, eos culpa.
                </p>
                <h5 class="text-base mt-10">Technologies Used</h5>
                <p class="flex items-center gap-2 text-slate-700 font-medium mt-3">
    ...
    <section class="py-14">
        <div class="container">
            <div class="grid md:grid-cols-3 grid-cols-1 gap-5 items-center py-7 border-y">
                <div>
                    <div>
                        <div class="flex items-center justify-start">
                            <button class="border border-gray-300 rounded-md text-sm tracking-wider transition-all duration-300 hover:shadow-lg py-2 px-5" data-fc-placement="top" data-fc-type="tooltip"> <i class="fa-solid fa-arrow-left me-2"></i>
                                Awesome Saas App </i>
                            </button>
                            <div class="bg-white shadow-lg hidden rounded-md transition-all opacity-0 z-50 p-4 w-72" role="tooltip">
                                <div class="flex items-center gap-5">
                                    <img src="assets/images/blog/blog-1.png" class="w-16 rounded">
                                    <div>
                                        <h6 class="text-sm">Introducing new blazzing fast user interface</h6>
                                        <p class="text-sm text-gray-500">by Emily Blunt</p>
                                    </div>
                                </div>
                                <div class="bg-white w-2.5 h-2.5 rotate-45 -z-10 rounded-[1px]" data-fc-arrow></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex md:justify-center">
                    <a href="#" class="border border-gray-300 rounded-md text-sm tracking-wider transition-all duration-300 hover:shadow-lg py-2 px-5">View All</a>
                </div>
                <div>
                    <div class="flex items-center md:justify-end justify-start">
                        <button class="border border-gray-300 rounded-md text-sm tracking-wider transition-all duration-300 hover:shadow-lg py-2 px-5" data-fc-placement="top" data-fc-type="tooltip">
                            Desktop App<i class="fa-solid fa-arrow-right ms-2"></i>
                        </button>
                        <div class="bg-white shadow-lg hidden rounded-md transition-all opacity-0 z-50 p-4 w-72" role="tooltip">
                            <div class="flex items-center gap-5">
                                <img src="assets/images/blog/blog-2.png" class="w-16 rounded">
                                <div>
                                    <h6 class="text-sm">What you should know before...</h6>
                                    <p class="text-sm text-gray-500">by Emily Blunt</p>
                                </div>
                            </div>
                            <div class="bg-white w-2.5 h-2.5 rotate-45 -z-10 rounded-[1px]" data-fc-arrow></div>
