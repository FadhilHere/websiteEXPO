        ...
        (function($) {
                    ...
                    _fold: function(point) {
                        ...
                        switch (data.effect) {
                            ...
                            case 'hard':
                                ...
                                data.fpage.transform('translateX(' + width + 'px) rotateY(' + (180 + angle) +
                                    'deg)', fpageOrigin);
                                ...
                                if (turnData.opts.gradients) {
                                    ...
                                    gradient(data.bshadow, point2D(gradientX * 100, 0), point2D((-gradientX + 1) *
                                            100, 0),
                                        [
                                            [0, 'rgba(0,0,0,0.3)'],
                                            [1, 'rgba(0,0,0,0)']
                                ...
                                var that = this,
                                    ...
                                    compute = function() {
                                        ...
                                        var alpha = A90 - Math.atan2(rel.y, rel.x),
                                            ...
                                            distance = Math.max(0, Math.sin(gamma) * Math.sqrt(Math.pow(middle.x,
                                                2) + Math.pow(middle.y, 2)));
                                        ...
                                        if (alpha > A90) {
                                            ...
                                            mv = point2D(Math.round(dd * Math.cos(beta)), Math.round(dd * Math.sin(
                                                beta)));
                                            if (left) mv.x = -mv.x;
                                            if (top) mv.y = -mv.y;
                                        }
                                        ...
                                        if (turnData.opts.gradients) {
                                            ...
                                            var endingPoint = flipMethods._c2.call(that, point.corner),
                                                far = Math.sqrt(Math.pow(endingPoint.x - point.x, 2) + Math.pow(
                                                    endingPoint.y - point.y, 2)) / width;
                                            ...
                                            gradientStartVal = gradientSize > 100 ? (gradientSize - 100) /
                                                gradientSize : 0;
                                    ...
                                    transform = function(tr, c, x, a) {
                                        ...
                                        data.fpage.css(cssA).transform(
                                            rotate(a) +
                                            translate(tr.x + df.x - mv.x - width * x[0] / 100, tr.y + df.y - mv
                                                .y - height * x[1] / 100, ac) +
                                            rotate((180 / a - 2) * a),
                                            origin);

                                        data.wrapper.transform(translate(-tr.x + mvW - aliasingFk, -tr.y + mvH,
                                            ac) + rotate(-a), origin);

                                        data.fwrapper.transform(translate(-tr.x + mv.x + mvW, -tr.y + mv.y + mvH,
                                            ac) + rotate(-a), origin);
                        ...
                        if (!data.disabled) {
                            ...
                            if (data.corner) {
                                ...
                                if (point) {
                                    ...
                                    if ((data.effect == 'sheet' && point.corner.length == 2) || data.effect ==
                                        'hard') {
                                        data.status = 'hover';
            ...
            function gradient(obj, p0, p1, colors, numColors) {
                ...
                if (vendor == '-webkit-') {
                    ...
                    for (j = 0; j < numColors; j++)
                        cols.push(' ' + colors[j][1] + ' ' + ((segA + gradientDiagonal * colors[j][0]) * 100 /
                            diagonal) + '%');
                    ...
                    if (point) {
                        ...
                        var diff = [],
                            ...
                            frame = function() {
                                ...
                                for (var i = 0; i < len; i++)
                                    v.push(data.effect.easing(1, timeDiff, point.from[i], diff[i], point
                                        .duration));
