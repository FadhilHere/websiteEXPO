                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link " href="{{ route('konten.list') }}">Tabel
                                        Konten</a> </li>
                                <li class="active"><a class="nav-link " href="{{ route('katalog.list') }}">Tabel
                                        Katalog</a> </li>
                            </ul>
                        </li>
                    </ul>
                                            ...
                                            <table class="table table-striped dataTable no-footer" id="table-1"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="table-1"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Isi: activate to sort column ascending">
                                                            Deskripsi
                                                        </th>
                                                        <th class="sorting" tabindex="0" aria-controls="table-1"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Menu: activate to sort column ascending">Foto
                                                        </th>
                                                        <th class="sorting" tabindex="0" aria-controls="table-1"
                                                            rowspan="1" colspan="1"
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="table-1"
                                                            rowspan="1" colspan="1"
                                                            aria-label="File: activate to sort column ascending">Tahun
                                                        </th>
                                                        <th class="sorting" tabindex="0" aria-controls="table-1"
                                                            rowspan="1" colspan="1"
                                                ...
                                                <tbody>
                                                    @forelse ($katalog as $index => $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($item->foto && is_array(json_decode($item->foto)))
                                                                    <a href="#"
                                                                        class="btn btn-primary btn-sm view-image"
                                                                        data-toggle="modal" data-target="#imageModal"
                                                                        data-images="{{ json_encode(array_map(fn($file) => asset('storage/' . $file), json_decode($item->foto))) }}">
                                                                        Lihat Gambar
                                                                    </a>
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                                    action="{{ route('katalog.destroy', $item->id) }}"
